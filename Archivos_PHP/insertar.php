<?php
	...
	$insertar = "insert into tabla_ubicacion(nombre,direccion,ubicacion,web,tipo,cod_usuario,pas_usuario) values ('".$nombre."','".$direccion."','".$ubicacion."','".$web."','".$tipo."','".$cod_usuario."','".$pas_usuario."')";
	
	// lanzar la consulta
	$query_exec = $mysqli->query($insertar);
	if (!$query_exec) {
		echo "Falló la inserción de en tabla_ubicacion: (" . $mysqli->errno . ") " . $mysqli->error;
	}	 
